...
import TotalSheet from "../../../../components/sheet/TotalSheet";
import AdjustmentSheet from "../../../../components/sheet/AdjustmentSheet";
import BasicSheet from "../../../../components/sheet/BasicSheet";
import ComparisonPropertySelector from "../../../../components/common/ComparisonPropertySelector";
...
function AppraisalWorksheet() {
    ...
    const handleToggleComparison = useCallback(async (appraisalId, comparisonId) => {
        ...
        const appraisalProperty = await indexedDBService.getPropertyById(appraisalId);
    ...
    const handleSaveAppraisal = useCallback(async () => {
        ...
        await axiosInstance.post(`/api/appraisals/assets/${id}`, payload);
